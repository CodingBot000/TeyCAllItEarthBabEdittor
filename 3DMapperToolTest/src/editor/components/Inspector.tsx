...
export function Inspector({ project, definition, activeFace, onActiveFace, onRotate, onReset, onFaceChange, onNameChange, materialSlots, selectedMaterialSlotId, onMaterialSlot }: InspectorProps) {
